              ...
              <div className="receipt-code-section">
                ...
                <div className="receipt-code-display">
                  <div className="receipt-code-text">
                    {receipt.masked_receipt_code || '—'}
                  </div>
                  <button
                    className="copy-code-btn"
                    onClick={() => handleCopyReceipt(receipt.masked_receipt_code, receipt.id)}
                    title="Copy masked receipt code"
                    disabled={!receipt.masked_receipt_code}
                  >
                    {copiedId === receipt.id ? (
